					...
					<div class="portlet light tasks-widget bordered">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green bold uppercase">点击时段</span>
								<span class="caption-helper">用户点击时段</span>
							</div>
							<div class="actions">
								<div class="btn-group">
...
<script src="<%=basePath%>/resources/pages/scripts/dashboard.js" type="text/javascript"></script>
