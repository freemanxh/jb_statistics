...
<div id="user_query" class="user_query">
		<form action="<%=basePath %>userlogs/newUsers.do" method="get" id="formbean">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<th>选择时间&nbsp;&nbsp; <label> 开始时间 <input
							name="startDate" id="startDate"
							onclick="fPopCalendar(event,this,this)" onfocus="this.select()"  value="${startDate }"
							readonly="readonly" />
					</label> <label> 结束时间 <input  id="endDate" name="endDate"
							onclick="fPopCalendar(event,this,this)" onfocus="this.select()" value="${endDate}"
							readonly="readonly" />
    ...
    新增用户:${view.allUserCountEntity.newUsers }<br/>
    
    活跃用户:${view.allUserCountEntity.activeUsers }<br/>
    累计用户:${view.allUserCountEntity.sumUser }<br/>
	    ...
	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	        ...
	        <c:forEach items="${view.listUserCountEntity}" var="item" varStatus="vs">
	            <tr class="select">
