					...
					<div class="portlet light tasks-widget bordered">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green bold uppercase">用户数统计</span>
								<span class="caption-helper">用户数统计</span>
							</div>
							<div class="actions">
								<div class="btn-group">
...
<script src="<%=basePath%>/resources/pages/scripts/newuser.js" type="text/javascript"></script>
